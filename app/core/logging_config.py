...
websocket_logger = setup_file_logger("websocket", "websocket.log", logging.DEBUG if not IS_PRODUCTION else logging.INFO)
...
portfolio_logger = setup_file_logger("portfolio", "portfolio.log", logging.INFO)
